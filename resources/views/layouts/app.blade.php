...
<head>
    ...
    <!-- Chart.js - Tambahkan ini sebelum Alpine.js -->
...
<body class="font-inter antialiased">
    <div class="min-h-screen bg-gray-50 flex">
        ...
        <aside class="fixed inset-y-0 left-0 bg-gradient-to-b from-indigo-700 to-purple-700 w-64 h-full">
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 px-2 py-4">
                    <a href="{{ route('dashboard') }}"
                        class="flex items-center px-4 py-2 text-gray-100 rounded-lg transition-all duration-200 ease-in-out font-medium
                              {{ request()->routeIs('dashboard') ? 'bg-white/10 shadow-lg' : 'hover:bg-white/5 hover:translate-x-1' }}">
                    ...
                    <a href="{{ route('admin.products.index') }}"
                        class="flex items-center px-4 py-2 mt-2 text-gray-100 rounded-lg transition-all duration-200 ease-in-out font-medium
                              {{ request()->routeIs('admin.products.*') ? 'bg-white/10 shadow-lg' : 'hover:bg-white/5 hover:translate-x-1' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('admin.users.index') }}"
                        class="flex items-center px-4 py-2 mt-2 text-gray-100 rounded-lg transition-all duration-200 ease-in-out font-medium
                              {{ request()->routeIs('admin.users.*') ? 'bg-white/10 shadow-lg' : 'hover:bg-white/5 hover:translate-x-1' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('admin.orders.index') }}"
                        class="flex items-center px-4 py-2 mt-2 text-gray-100 rounded-lg transition-all duration-200 ease-in-out font-medium
                              {{ request()->routeIs('admin.orders.*') ? 'bg-white/10 shadow-lg' : 'hover:bg-white/5 hover:translate-x-1' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('admin.analytics') }}"
                        class="flex items-center px-4 py-2 mt-2 text-gray-100 rounded-lg transition-all duration-200 ease-in-out font-medium
                              {{ request()->routeIs('admin.analytics') ? 'bg-white/10 shadow-lg' : 'hover:bg-white/5 hover:translate-x-1' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="p-4" x-data="{ showLogoutModal: false }">
                    ...
                    <!-- Logout Modal -->
                    <div x-show="showLogoutModal" class="fixed inset-0 z-[9999] overflow-y-auto" style="display: none;">
        ...
        <!-- Notification Container - Letakkan setelah sidebar dan sebelum main content -->
