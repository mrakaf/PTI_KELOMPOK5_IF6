                                ...
                                @foreach ($carts as $cart)
                                    <div
                                        ...
                                        <img src="{{ Storage::url($cart->product->image) }}"
                                            alt="{{ $cart->product->name }}" class="w-24 h-24 object-cover rounded-lg"
                                            onerror="this.src='{{ asset('images/placeholder.jpg') }}'">

                                        <!-- Product Details -->
                                        <div class="flex-1">
                                            <h3 class="font-semibold text-gray-900 text-lg">{{ $cart->product->name }}
                                            </h3>
                                            <p class="text-gray-500 text-sm mt-1">SKU: {{ $cart->product->id }}</p>
                                        ...
                                        <div class="flex items-center gap-4">
                                            ...
                                            <input type="checkbox" class="form-checkbox h-5 w-5 text-indigo-600"
                                                ...
                                                onchange="toggleSelection({{ $cart->id }}, this)">
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                        ...
                        <div class="mt-6 bg-white rounded-lg shadow-sm p-6">
                            ...
                            <div class="mb-4">
                                <span id="selectedItemCount" class="text-sm text-gray-600">
                                    Selected {{ $carts->where('selected', true)->count() }}
                                    {{ $carts->where('selected', true)->count() === 1 ? 'item' : 'items' }}
                                </span>
                            </div>
