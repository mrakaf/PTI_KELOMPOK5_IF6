    ...
    <div x-data="{ 
        ...
        <div x-show="showLoginAlert"
            ...
            <div class="bg-blue-500 text-white px-6 py-3 rounded-lg shadow-lg flex items-center space-x-3">
                ...
                <a href="{{ route('register') }}" class="underline hover:text-blue-200">Register here</a>
            </div>
        </div>
                ...
                <div class="relative h-[700px] overflow-hidden">
                    <div class="flex h-full" 
                        ...
                        <div class="min-w-full relative">
                            <img src="{{ asset('images/hero/first.jpg') }}" 
                                 alt="First Slide" 
                        ...
                        <!-- Slide 2 -->
                        <div class="min-w-full relative">
                            <img src="{{ asset('images/hero/second.jpg') }}" 
                                 alt="Second Slide" 
                                 class="w-full h-full object-cover object-position-top" 
                        ...
                        <!-- Slide 3 -->
                        <div class="min-w-full relative">
                            <img src="{{ asset('images/hero/third.jpg') }}" 
                                 alt="Third Slide" 
                                 class="w-full h-full object-cover object-position-top" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div class="bg-white rounded-lg shadow-md overflow-hidden group">
                            <div class="relative h-[300px] overflow-hidden">
                                <img src="{{ asset('images/categories/woman.jpg') }}" 
                                     alt="Woman Fashion" 
                        ...
                        <div class="bg-white rounded-lg shadow-md overflow-hidden group">
                            <div class="relative h-[300px] overflow-hidden">
                                <img src="{{ asset('images/categories/men.jpg') }}" 
                                     alt="Men Fashion" 
                                     class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
                                <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-40 transition-all duration-300 flex items-center justify-center">
                        ...
                        <div class="bg-white rounded-lg shadow-md overflow-hidden group">
                            <div class="relative h-[300px] overflow-hidden">
                                <img src="{{ asset('images/categories/zipper.jpg') }}" 
                                     alt="Fashion" 
                                     class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
                                <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-40 transition-all duration-300 flex items-center justify-center">
        ...
        <section id="categories" class="py-16">
            <div class="container mx-auto px-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="bg-white rounded-lg shadow-lg overflow-hidden group hover:shadow-xl transition-all duration-300">
                        <div class="category-image-container relative">
                            <img src="{{ asset('images/categories/gelang.jpg') }}" 
                                 alt="Accessories" 
                                 class="category-image transform group-hover:scale-110 transition duration-500">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent">
                                <div class="absolute bottom-4 left-4 right-4">
