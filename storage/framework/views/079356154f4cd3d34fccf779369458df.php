...
<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-white shadow-lg rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-xl">
        <div class="p-6">
            ...
            <div class="mb-6">
                <form action="<?php echo e(route('admin.products.index')); ?>" method="GET" class="flex gap-4">
                    <div class="flex-1">
                    ...
                    <div class="w-48">
                        <select name="sort"
                            ...
                            <option value="name_asc" <?php echo e(request('sort') == 'name_asc' ? 'selected' : ''); ?>>Name (A-Z)
                            </option>
                            <option value="name_desc" <?php echo e(request('sort') == 'name_desc' ? 'selected' : ''); ?>>Name (Z-A)
                            </option>
                            <option value="price_asc" <?php echo e(request('sort') == 'price_asc' ? 'selected' : ''); ?>>Price
                                (Low-High)</option>
                            <option value="price_desc" <?php echo e(request('sort') == 'price_desc' ? 'selected' : ''); ?>>Price
                                (High-Low)</option>
                            <option value="stock_asc" <?php echo e(request('sort') == 'stock_asc' ? 'selected' : ''); ?>>Stock
                                (Low-High)</option>
                            <option value="stock_desc" <?php echo e(request('sort') == 'stock_desc' ? 'selected' : ''); ?>>Stock
                                (High-Low)</option>
                        </select>
                    </div>
                    <button type="submit"
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 transition-colors duration-200" id="product-<?php echo e($product->id); ?>">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap font-poppins">
                                    <span class="text-indigo-600 font-semibold"><?php echo e($product->formatted_price); ?></span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap font-poppins">
                                    <span
                                        class="px-3 py-1 rounded-full text-sm <?php echo e($product->stock > 10 ? 'bg-green-100 text-green-800' : ($product->stock > 0 ? 'bg-yellow-100 text-yellow-800' : 'bg-red-100 text-red-800')); ?>">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap font-poppins">
                                    <span
                                        class="px-3 py-1 rounded-full text-sm <?php echo e($product->is_active ? 'bg-emerald-100 text-emerald-800' : 'bg-red-100 text-red-800'); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\PTI_KELOMPOK5_IF6\resources\views/admin/products/index.blade.php ENDPATH**/ ?>