                        ...
                        <div class="grid grid-cols-2 gap-6 animate-float-luxury">
                            ...
                            <div class="space-y-6">
                                <div
                                    ...
                                    <img src="<?php echo e(asset('storage/products/jacket2.jpg')); ?>" alt="Fashion"
                                ...
                                <div
                                    class="group relative rounded-2xl overflow-hidden shadow-2xl transform hover:scale-105 transition-all duration-500">
                                    <img src="<?php echo e(asset('storage/products/jacket1.jpg')); ?>" alt="Fashion"
                            ...
                            <div class="space-y-6 pt-12">
                                <div
                                    class="group relative rounded-2xl overflow-hidden shadow-2xl transform hover:scale-105 transition-all duration-500">
                                    <img src="<?php echo e(asset('storage/products/leatherjacket.jpg')); ?>" alt="Fashion"
                                        class="w-full h-64 object-cover">
                                    <div
                                        class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    </div>
                                ...
                                <div
                                    class="group relative rounded-2xl overflow-hidden shadow-2xl transform hover:scale-105 transition-all duration-500">
                                    <img src="<?php echo e(asset('storage/products/jacket3.jpg')); ?>" alt="Fashion"
                                        class="w-full h-48 object-cover">
                                    <div
                                        class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <a href="#"
                    ...
                    <div class="aspect-w-1 aspect-h-1">
                        <img src="<?php echo e(asset('storage/products/jacket1.jpg')); ?>" alt="Clothing"
                ...
                <a href="#"
                    class="group relative rounded-2xl overflow-hidden bg-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                    <div class="aspect-w-1 aspect-h-1">
                        <img src="<?php echo e(asset('storage/products/loafers.jpg')); ?>" alt="Shoes"
                            class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-700">
                        <div
                            class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent opacity-80 group-hover:opacity-90 transition-opacity duration-300">
                        </div>
                ...
                <a href="#"
                    class="group relative rounded-2xl overflow-hidden bg-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                    <div class="aspect-w-1 aspect-h-1">
                        <img src="<?php echo e(asset('storage/products/gelang.jpg')); ?>" alt="Accessories"
                            class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-700">
                        <div
                            class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent opacity-80 group-hover:opacity-90 transition-opacity duration-300">
                        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div
                        ...
                        <!-- Product Info -->
                        <div class="p-6">
                            <h3 class="text-lg font-semibold text-gray-900 mb-2 line-clamp-1"><?php echo e($product->name); ?>
...
<?php endif; ?>
    ...
    <footer class="bg-gray-800 text-white py-8 mt-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <p>&copy; <?php echo e(date('Y')); ?> RobbStark Shop. All rights reserved.</p>
            </div>
        </div>
    </footer>
...
<?php /**PATH E:\laragon\www\PTI_KELOMPOK5_IF6\resources\views/customer/index.blade.php ENDPATH**/ ?>